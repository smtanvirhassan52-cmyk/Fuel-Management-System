...
partial class ReviewsPanel
{
    ...
    private System.Windows.Forms.Button btnAddReview = null!;
    ...
    private void InitializeComponent()
    {
        ...
        lblTitle.Size = new Size(134, 46);
        lblTitle.TabIndex = 0;
        lblTitle.Text = "Reviews";
        // 
        // btnAddReview
        // 
        btnAddReview.BackColor = Color.FromArgb(40, 200, 120);
        btnAddReview.Cursor = Cursors.Hand;
        btnAddReview.FlatAppearance.BorderSize = 0;
        btnAddReview.FlatStyle = FlatStyle.Flat;
        btnAddReview.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
        btnAddReview.ForeColor = Color.White;
        btnAddReview.Location = new Point(0, 50);
        ...
        btnRefresh.Location = new Point(150, 50);
